...
source_spec_hash: e4b6c3ee2bde6a8e74670defd56e065d7fd77d6b1213b6bc634ce813b7718aaa
version: 1.0.0
status: draft
...
Prove the approved Evidence and Claims Spec at its public service/tool/Remote/browser seams. Execution results belong in `evidence/`.

In scope: REQ-R001-005, REQ-R001-006, REQ-R001-009, AC-R001-005, AC-R001-006, AC-R001-009, AC-R001-012. Out of scope: R002 and R001 Non-Goals.

## 2. Coverage Matrix

| Requirement | Spec | Test | Category / level | Required Evidence | Gate |
|---|---|---|---|---|---|
| REQ-R001-005, REQ-R001-006, REQ-R001-009 | SPEC-R001-S04-001 | TEST-R001-S04-001 | happy / integration | assertion report + persisted state | blocking |
| REQ-R001-005, REQ-R001-006, REQ-R001-009 | SPEC-R001-S04-001, SPEC-R001-S04-002, SPEC-R001-S04-003 | TEST-R001-S04-002 | negative / contract | error and no-illegal-side-effect assertions | blocking |
| INV/EDGE mapped by Spec | SPEC-R001-S04-001, SPEC-R001-S04-002, SPEC-R001-S04-003 | TEST-R001-S04-003 | invariant / E2E | trace + domain state | blocking |
| REQ-R001-009 | SPEC-R001-S04-001, SPEC-R001-S04-002, SPEC-R001-S04-003 | TEST-R001-S04-004 | UI / browser | screenshots + trace at desktop/narrow | blocking |
| AC-R001-005, AC-R001-006, AC-R001-009, AC-R001-012 | SPEC-R001-S04-001, SPEC-R001-S04-002, SPEC-R001-S04-003 | TEST-R001-S04-005 | release scenario | normalized run + raw refs | blocking |

## 3. Test Environment and Data

- Fixtures / dependencies: medical-domain/evidence tests; research-chain; Gold Set; browser.
...
| browser-ui | supported dsh med-research profile | 搜索研究.png groups plus citation-to-reader | screenshots, console, interaction trace | blocking |
...
Covers: REQ-R001-005, REQ-R001-006, REQ-R001-009; SPEC-R001-S04-001, SPEC-R001-S04-002, SPEC-R001-S04-003; AC-R001-005, AC-R001-006, AC-R001-009, AC-R001-012.
Given valid versioned inputs and an isolated Project, when Retrieve-locate-verify-gate-serialize-open source, then public output, persisted state, UI state, audit, and identifiers agree.
Required evidence / gate: raw assertions plus normalized mapping / blocking.

### TEST-R001-S04-002 Failure honesty
Covers: mapped BR/INV/EDGE and SPEC-R001-S04-001, SPEC-R001-S04-002, SPEC-R001-S04-003.
Given NOT_FOUND, dangling/unsupported Claim, missing counter-evidence, when the public seam runs, then it returns the declared stable failure/partial state and creates no forbidden state, source, result, or success feedback.
...
Given real service data for loading, empty, success, partial, and failure, when rendered at desktop and narrow viewports, then 搜索研究.png groups plus citation-to-reader; primary actions remain keyboard reachable, localized, readable, and non-overlapping; console has no uncaught errors.
...
Covers: AC-R001-005, AC-R001-006, AC-R001-009, AC-R001-012.
...
- Regression: medical-domain/evidence tests; research-chain; Gold Set; browser; adjacent shared contracts and med profile composition.
