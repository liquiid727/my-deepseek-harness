...
source_spec_hash: 69daeb672981809873e7d047cae2bc05460e611a5dda500ba9b91308de1f4591
version: 1.0.0
status: draft
...
# Test Design - S01 Project Workspace

## 1. Purpose and Scope

Prove the approved Project Workspace Spec at its public service/tool/Remote/browser seams. Execution results belong in `evidence/`.

In scope: REQ-R001-001, REQ-R001-009, REQ-R001-010, AC-R001-001, AC-R001-009, AC-R001-011. Out of scope: R002 and R001 Non-Goals.

## 2. Coverage Matrix

| Requirement | Spec | Test | Category / level | Required Evidence | Gate |
|---|---|---|---|---|---|
| REQ-R001-001, REQ-R001-009, REQ-R001-010 | SPEC-R001-S01-001 | TEST-R001-S01-001 | happy / integration | assertion report + persisted state | blocking |
| REQ-R001-001, REQ-R001-009, REQ-R001-010 | SPEC-R001-S01-001, SPEC-R001-S01-002, SPEC-R001-S01-003 | TEST-R001-S01-002 | negative / contract | error and no-illegal-side-effect assertions | blocking |
| INV/EDGE mapped by Spec | SPEC-R001-S01-001, SPEC-R001-S01-002, SPEC-R001-S01-003 | TEST-R001-S01-003 | invariant / E2E | trace + domain state | blocking |
| REQ-R001-009 | SPEC-R001-S01-001, SPEC-R001-S01-002, SPEC-R001-S01-003 | TEST-R001-S01-004 | UI / browser | screenshots + trace at desktop/narrow | blocking |
| AC-R001-001, AC-R001-009, AC-R001-011 | SPEC-R001-S01-001, SPEC-R001-S01-002, SPEC-R001-S01-003 | TEST-R001-S01-005 | release scenario | normalized run + raw refs | blocking |

## 3. Test Environment and Data

- Fixtures / dependencies: plugin-project tests; medical-ui view/component tests; real profile browser.
...
| browser-ui | supported dsh med-research profile | 首页.png desktop/narrow state matrix | screenshots, console, interaction trace | blocking |
...
Covers: REQ-R001-001, REQ-R001-009, REQ-R001-010; SPEC-R001-S01-001, SPEC-R001-S01-002, SPEC-R001-S01-003; AC-R001-001, AC-R001-009, AC-R001-011.
Given valid versioned inputs and an isolated Project, when Project create/reload/bind/count, then public output, persisted state, UI state, audit, and identifiers agree.
Required evidence / gate: raw assertions plus normalized mapping / blocking.

### TEST-R001-S01-002 Failure honesty
Covers: mapped BR/INV/EDGE and SPEC-R001-S01-001, SPEC-R001-S01-002, SPEC-R001-S01-003.
Given No binding, invalid config/import, denied mode, when the public seam runs, then it returns the declared stable failure/partial state and creates no forbidden state, source, result, or success feedback.
...
Given real service data for loading, empty, success, partial, and failure, when rendered at desktop and narrow viewports, then 首页.png desktop/narrow state matrix; primary actions remain keyboard reachable, localized, readable, and non-overlapping; console has no uncaught errors.
...
Covers: AC-R001-001, AC-R001-009, AC-R001-011.
...
- Regression: plugin-project tests; medical-ui view/component tests; real profile browser; adjacent shared contracts and med profile composition.
