...
|---|---|
| PRD | 2.1.0 |
| Spec | 2.1.0 / 79809d3272192f4fb499282875e200016dc1c7daa01aefa3b729aa749c72d1f6 |
...
|---|---|---|---|
| Historical 1.0 implementation inventory | SPEC-R001-S02-001 through SPEC-R001-S02-003 | ./evidence/implementation.md | pending normalization |
| Historical verification index | TEST-R001-S02-001 through TEST-R001-S02-005 | ./evidence/index.yaml | empty |
...
Spec 2.1.0 approved；Test Design 2.0.0 为 review，尚待人工批准。AC-R001-002, AC-R001-003, AC-R001-013, AC-R001-014, AC-R001-015, AC-R001-016 当前全部 pending。上述历史覆盖和运行记录保留原版本身份，不构成当前验收；当前覆盖以 [Test Design](test.md)和[逐项矩阵](../../coverage.md)为准。本次没有运行实现、UI 或医学评估，decision 仍 blocked，promotion 仍 denied。
