...
source_spec_hash: edb9fc9dbe39e0872316482afb4178049c200c5785559ae2e00f7e97c72c3d8e
version: 1.0.0
status: draft
...
# Test Design - S03 Paper Reading

## 1. Purpose and Scope

Prove the approved Paper Reading Spec at its public service/tool/Remote/browser seams. Execution results belong in `evidence/`.

In scope: REQ-R001-004, REQ-R001-009, AC-R001-004, AC-R001-005, AC-R001-009. Out of scope: R002 and R001 Non-Goals.

## 2. Coverage Matrix

| Requirement | Spec | Test | Category / level | Required Evidence | Gate |
|---|---|---|---|---|---|
| REQ-R001-004, REQ-R001-009 | SPEC-R001-S03-001 | TEST-R001-S03-001 | happy / integration | assertion report + persisted state | blocking |
| REQ-R001-004, REQ-R001-009 | SPEC-R001-S03-001, SPEC-R001-S03-002, SPEC-R001-S03-003 | TEST-R001-S03-002 | negative / contract | error and no-illegal-side-effect assertions | blocking |
| INV/EDGE mapped by Spec | SPEC-R001-S03-001, SPEC-R001-S03-002, SPEC-R001-S03-003 | TEST-R001-S03-003 | invariant / E2E | trace + domain state | blocking |
| REQ-R001-009 | SPEC-R001-S03-001, SPEC-R001-S03-002, SPEC-R001-S03-003 | TEST-R001-S03-004 | UI / browser | screenshots + trace at desktop/narrow | blocking |
| AC-R001-004, AC-R001-005, AC-R001-009 | SPEC-R001-S03-001, SPEC-R001-S03-002, SPEC-R001-S03-003 | TEST-R001-S03-005 | release scenario | normalized run + raw refs | blocking |

## 3. Test Environment and Data

- Fixtures / dependencies: plugin-paper/fulltext tests; medical-ui focus/view tests; browser.
...
| browser-ui | supported dsh med-research profile | 论文阅读器.png desktop/narrow and selection states | screenshots, console, interaction trace | blocking |
...
Covers: REQ-R001-004, REQ-R001-009; SPEC-R001-S03-001, SPEC-R001-S03-002, SPEC-R001-S03-003; AC-R001-004, AC-R001-005, AC-R001-009.
Given valid versioned inputs and an isolated Project, when Open abstract/JATS/PDF and navigate sections, then public output, persisted state, UI state, audit, and identifiers agree.
Required evidence / gate: raw assertions plus normalized mapping / blocking.

### TEST-R001-S03-002 Failure honesty
Covers: mapped BR/INV/EDGE and SPEC-R001-S03-001, SPEC-R001-S03-002, SPEC-R001-S03-003.
Given Parse failure, abstract-only, malformed/stale focus, when the public seam runs, then it returns the declared stable failure/partial state and creates no forbidden state, source, result, or success feedback.
...
Given real service data for loading, empty, success, partial, and failure, when rendered at desktop and narrow viewports, then 论文阅读器.png desktop/narrow and selection states; primary actions remain keyboard reachable, localized, readable, and non-overlapping; console has no uncaught errors.
...
Covers: AC-R001-004, AC-R001-005, AC-R001-009.
...
- Regression: plugin-paper/fulltext tests; medical-ui focus/view tests; browser; adjacent shared contracts and med profile composition.
