...
export const zh: Dictionary = {
  ...
  'mode.paper': '论文',
  'mode.statistics': '统计',
  'home.prompt': '描述你的科研问题，从这里开始。',
  'home.eyebrow': '医学科研工作台',
  'home.title': '让临床问题变得可追溯。',
  'home.overview': '项目概览',
  'home.overviewHint': '已保存的研究状态',
  'home.projectHint': '进入项目工作区',
  'home.papersDescription': '检索并阅读真实文献，保留完整来源上下文。',
  'home.evidenceDescription': '用可核验的原文片段和引用组织证据。',
  'home.statisticsDescription': '查看数据概览，准备可复现的统计分析。',
  'home.openWorkspace': '打开研究工作区',
  'home.loading': '正在加载项目概览…',
  'home.createTitle': '新建项目',
  'home.name': '项目名称',
  'home.question': '研究问题',
  'home.create': '创建项目',
