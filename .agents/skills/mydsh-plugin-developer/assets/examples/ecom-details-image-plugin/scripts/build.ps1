# One-shot rebuild of ecom-details-image-plugin (node half + browser half).
...
Write-Host "  dsh plugin --profile web add file:D:/dsh-openmaic-main/ecom-details-image-plugin"
Write-Host "  dsh plugin --profile headless add file:D:/dsh-openmaic-main/ecom-details-image-plugin"
