/**
 * tsdown preset for a dsh plugin: an ESM node half with declarations plus a
 ...
 * platform module table external and bundles the shared fragment inline.
 * @see README.md / references/build-test.md
 */
import type { UserConfig } from 'tsdown'

const PLUGIN_ID = '@yourscope/your-plugin'
...
export default [
  {
    ...
    deps: {
      ...
      // `Config` schema and must see its own instance; cordis is type-only.
