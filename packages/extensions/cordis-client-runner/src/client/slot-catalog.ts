...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'session',
    summary: 'Session-owned launch controls shown while the blank-session Hero is visible.',
    doc: 'Session-owned launch controls shown while the blank-session Hero is visible.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
  ...
  {
    key: 'conversation.hero.launch',
    kind: 'list',
    scope: 'root',
    summary: 'Root-level launch controls shown before a Session exists.',
    doc: 'Root-level launch controls shown before a Session exists.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.hero.launch\', () => ctx.slots.register(\n      { name: \'conversation.hero.launch\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
