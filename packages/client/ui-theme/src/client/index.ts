...
const BUILTIN_INSPECT_TOKENS: readonly ThemeTokenInspection[] = Object.freeze([
  ...
  { name: '--dsw-alias-accent-primary', description: 'Accent for selection rails and non-text emphasis.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--dsw-alias-accent-primary' },
  { name: '--dsw-alias-accent-strong', description: 'Accessible primary action fill.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--dsw-alias-accent-strong' },
  { name: '--dsw-alias-accent-hover', description: 'Primary action hover fill.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--dsw-alias-accent-hover' },
  { name: '--dsw-alias-accent-soft', description: 'Low-emphasis accent surface.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--dsw-alias-accent-soft' },
  { name: '--dsw-alias-focus-ring', description: 'Keyboard focus indicator.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--dsw-alias-focus-ring' },
  { name: '--dsw-alias-label-on-accent', description: 'Text and icon color placed on an accent fill.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--dsw-alias-label-on-accent' },
  ...
  { name: '--dsw-alias-state-error-label', description: 'Accessible error label color.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--dsw-alias-state-error-label' },
  ...
  { name: '--dsw-alias-state-success-label', description: 'Accessible success label color.', valueType: 'CSS color', requiresLightAndDark: true, cssVariable: '--dsw-alias-state-success-label' },
